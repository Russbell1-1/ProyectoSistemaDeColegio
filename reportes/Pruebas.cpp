...
void loginProfesor(Profesor* profesores[], int nProf, Estudiante* estudiantes[], int nEst);      // Login para ingresar al menú de profesor
void menuProfesor(Profesor* profesor, Profesor* profesores[], int nProf, Estudiante* estudiantes[], int nEst);
	...
	do{
        ...
        switch(opcionmenu){
            case 'A':
                ...
                break;
            case 'B':
                loginProfesor(profesores, nProf, estudiantes, n);
                break;
            case 'X':
                cout<<"Cerrando programa..."<<endl;
                Sleep(1000);
...
//-------------------------- LOGIN PROFESOR --------------------------
void loginProfesor(Profesor* profesores[], int nProf, Estudiante* estudiantes[], int nEst){
    int rpta;
    char resto;
    do{
        system("cls");
        ...
        switch(rpta){
            case 1:{
                ...
                if(encontrado){
                    cout<<"Inicio de sesión exitoso\n";
                    Sleep(1000);
                    menuProfesor(profesores[pos], profesores, nProf, estudiantes, nEst);
                    return;
                } else{
                    cout<<"Contraseña incorrecta\n";
                    system("pause");
